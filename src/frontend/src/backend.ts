...
export class Backend implements backendInterface {
    ...
    async getPosts(arg0: bigint, arg1: bigint, arg2: string | null, arg3: string | null, arg4: string): Promise<{
        total: bigint;
        posts: Array<BlogPost>;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getPosts(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n1(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentPosts(arg0: bigint): Promise<Array<BlogPost>> {
        if (this.processError) {
            try {
    ...
    async searchSuggestions(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchSuggestions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
